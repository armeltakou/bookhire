    ...
    <div class="scrollbar-inner">
        ...
        <div class="user">
            <div class="user__info" data-toggle="dropdown">
                <img class="user__img" src="<?php echo demoimg_url('profile-pics/8.jpg'); ?>" alt="">
                <div>
...
<div class="themes">
    <div class="scrollbar-inner">
        <a href="#" class="themes__item active" data-sa-value="1"><img src="<?php echo img_url('bg/1.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="2"><img src="<?php echo img_url('bg/2.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="3"><img src="<?php echo img_url('bg/3.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="4"><img src="<?php echo img_url('bg/4.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="5"><img src="<?php echo img_url('bg/5.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="6"><img src="<?php echo img_url('bg/6.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="7"><img src="<?php echo img_url('bg/7.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="8"><img src="<?php echo img_url('bg/8.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="9"><img src="<?php echo img_url('bg/9.jpg'); ?>" alt=""></a>
        <a href="#" class="themes__item" data-sa-value="10"><img src="<?php echo img_url('bg/10.jpg'); ?>" alt=""></a>
    </div>
</div>