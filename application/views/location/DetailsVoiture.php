    ...
    <div class="home">
        <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo image_url('voiture/banner.jpg'); ?>" style="background-size: cover;" data-speed="0.8"></div>
				...
				<div class="col-lg-6">
					<div class="news_posts">
						...
						<div class="news_post">
							<div class="news_post_title_container d-flex flex-row align-items-center justify-content-start">
								...
								<div class="news_post_title_content">
									<div class="news_post_title"><a href="#">Mercedes</a></div>
							...
							<div class="news_post_image"><img src="<?php echo image_url('voiture/voiture1.jpg'); ?>" alt=""></div>
						...
						<div class="news_post">
							...
							<div class="news_post_image"><img src="<?php echo image_url('voiture/voiture2.jpg'); ?>" alt=""></div>
							<div class="news_post_text">
								<p>Donec ullamcorper nulla non metus auctor fringi lla. Curabitur blandit tempus porttitor.Sed lectus urna, ultricies sit amet risus eget, euismod imperdiet augue. Duis imperdiet, purus a pellentesque sodales, sapien mauris rhoncus eros, ac blandit elit leo ac diam.</p>
							</div>
						</div>
					...
					<div class="sidebar">
						...
						<div class="sidebar_top_search">
							<form action="#" class="sidebar_top_search_form">
								<input type="text" class="sidebar_top_search_input" placeholder="Rechercher votre voiture..." required="required">
