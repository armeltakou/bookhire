	<div class="recent">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title">Les artistes les plus populaires</div>
						...
						<div class="owl-carousel owl-theme recent_slider">
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="<?php echo image_url('artiste/artiste.jpeg'); ?>" style="height: 300px;" alt="">
										...
										<div class="recent_item_body text-center">
											...
											<div class="recent_item_title"><a href="<?php echo site_url(array('Location','DetailsArtiste')) ?>">Les artistes</a></div>
											<div class="recent_item_price">Collections</div>
										</div>
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="<?php echo image_url('artiste/artiste2.jpg'); ?>" style="height: 300px;" alt="">
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
                                        <div class="recent_item_inner">
                                            <div class="recent_item_image">
                                                <img src="<?php echo image_url('artiste/artiste3.jpg'); ?>" style="height: 300px;" alt="">
                                                <div class="tag_offer property_tag"><a href="#">Occupé</a></div>
                                            </div>
                                            <div class="recent_item_body text-center">
                                                <div class="recent_item_location">Douala</div>
