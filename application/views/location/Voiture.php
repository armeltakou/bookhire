	<div class="recent">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title">Les voitures les plus utilisées</div>
					<div class="section_subtitle">Ce sont des voitures de marques et dernières générations.</div>
				</div>
			</div>
						...
						<div class="owl-carousel owl-theme recent_slider">
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="<?php echo image_url('voiture/voiture1.jpg'); ?>" style="height: 300px;" alt="">
											<div class="tag_featured property_tag"><a href="">Dispoible</a></div>
										</div>
										<div class="recent_item_body text-center">
											<div class="recent_item_location">Yaoundé</div>
											<div class="recent_item_title"><a href="<?php echo site_url(array('Location','DetailsVoiture')) ?>">Voiture</a></div>
											<div class="recent_item_price">Voiture décorée</div>
										</div>
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="<?php echo image_url('voiture/voiture2.jpg'); ?>" style="height: 300px;" alt="">
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="<?php echo image_url('voiture/voiture4.jpg'); ?>" style="height: 300px;" alt="">
