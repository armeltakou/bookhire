	<div class="recent">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title">Les salles les plus en vogues</div>
						...
						<div class="owl-carousel owl-theme recent_slider">
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="<?php echo image_url('salle/conferences.jpeg'); ?>" style="height: 300px;" alt="">
										...
										<div class="recent_item_body text-center">
											...
											<div class="recent_item_title"><a href="<?php echo site_url(array('Location','DetailsSalle')) ?>">Salle de conférence</a></div>
											<div class="recent_item_price">Description de la salle</div>
										</div>
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
                                        <div class="recent_item_image">
                                            <img src="<?php echo image_url('salle/Salle-fetes-ceremonies.jpg'); ?>" style="height: 300px;" alt="">
                                            <div class="tag_featured property_tag"><a href="">Dispoible</a></div>
                                        </div>
                                        <div class="recent_item_body text-center">
                                            <div class="recent_item_location">Douala</div>
                                            <div class="recent_item_title"><a href="<?php echo site_url(array('Location','DetailsSalle')) ?>">Salle de fête de mariage</a></div>
                                            <div class="recent_item_price">Description de la salle</div>
                                        </div>
                                        <div class="recent_item_footer d-flex flex-row align-items-center justify-content-start">
                                            <div><div class="recent_icon"><i class="fa fa-shopping-cart" aria-hidden="true"></i></div><span><a href="<?php echo site_url(array('Location','AddPanier')) ?>" style="color: white;">L'ajouter au panier</a></span></div>
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
                                        <div class="recent_item_image">
                                            <img src="<?php echo image_url('salle/concert2.jpg'); ?>" style="height: 300px;" alt="">
                                            <div class="tag_featured property_tag"><a href="">Dispoible</a></div>
                                        </div>
                                        <div class="recent_item_body text-center">
                                            <div class="recent_item_location">Douala</div>
                                            <div class="recent_item_title"><a href="<?php echo site_url(array('Location','DetailsSalle')) ?>">Salle de concert</a></div>
                                            <div class="recent_item_price">Description de la salle</div>
                                        </div>
                                        <div class="recent_item_footer d-flex flex-row align-items-center justify-content-start">
                                            <div><div class="recent_icon"><i class="fa fa-shopping-cart" aria-hidden="true"></i></div><span><a href="<?php echo site_url(array('Location','AddPanier')) ?>" style="color: white;">L'ajouter au panier</a></span></div>
